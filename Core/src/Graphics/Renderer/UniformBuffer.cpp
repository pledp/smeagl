...
namespace pledGL {
    ...
    void UniformBuffer::CreateBuffer(const uint32_t size, const uint32_t binding) {
    ...
    void UniformBuffer::SetData(const void* data, const uint32_t size, const uint32_t offset) {
        glBindBuffer(GL_UNIFORM_BUFFER, m_buffer_id);
