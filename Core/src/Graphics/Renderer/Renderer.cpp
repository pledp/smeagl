...
namespace pledGL {
    ...
    void Renderer::DrawTri(const Vector3& pos, const Vector3& size) {
        DrawTri(pos, size, {1.0f, 1.0f, 1.0f});
    }

    void Renderer::DrawTri(const Vector3& pos, const Vector3& size, const Vector3& color) {
    ...
    void Renderer::DrawQuad(const Vector3& pos, const Vector3& size) {
        DrawQuad(pos, size, {1.0f, 1.0f, 1.0f});
    }

    void Renderer::DrawQuad(const Vector3& pos, const Vector3& size, const Vector3& color) {
    ...
    void Renderer::ClearScreen(const Vector3& color) {
